...
See `docs/00-overview/2-classification-reference.md` for the full classification framework including IMDRF significance categories and national market mappings.